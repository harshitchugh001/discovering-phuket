			...
			<td class="">
				...
				<?php if ( ! class_exists( 'Woo_Conditional_Shipping_Pro' ) ) { ?>
					<p class="description conditions-desc">
						<?php printf( __( 'More conditions available in <a href="%s" target="_blank">the Pro version</a>.', 'woo-conditional-shipping' ), 'https://wptrio.com/products/conditional-shipping' ); ?>
					</p>
				<?php } ?>
			</td>
		</tr>
			...
			<fieldset class="wcs_action_value_inputs">
				<div class="value_input wcs_price_value_input">
					...
					<select name="wcs_actions[{{data.index}}][price_mode]">
						...
						<option value="pct_shipping" <# if ( data.price_mode === "pct_shipping" ) { #>selected<# } #>>% of shipping</option>
					</select>
				</div>
