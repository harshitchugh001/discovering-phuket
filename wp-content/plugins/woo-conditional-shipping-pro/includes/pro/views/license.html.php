<tr valign="top" class="">
	...
	<td class="forminp">
		<input type="text" name="license_woo_conditional_shipping_pro" id="license_woo_conditional_shipping_pro" value="<?php echo esc_attr( $license_key ); ?>" />
		<p class="description"><?php printf( __( 'You can re-order your license key <a href="%s" target="_blank">here</a> (WP Trio) or <a href="%s" target="_blank">here</a> (Markup.fi) if you don\'t have it.', 'woo-stock-sync' ), 'https://wptrio.com/get-your-license-keys/', 'https://markup.fi/lisenssiavaimien-tilaus/' ); ?></p>
	</td>
</tr>
