...
class Woo_Conditional_Payments_Pro_License {
	public $id = 'conditional_payments_for_woocommerce_pro';
	public $slug = 'conditional-payments-for-woocommerce-pro';
	public $plugin_file = WOO_CONDITIONAL_PAYMENTS_PRO_FILE; 
	...
	public function __construct() {
		...
		add_action( 'woo_conditional_payments_after_settings', [ $this, 'add_license_settings' ] );

		// Save and update license
		add_action( 'woocommerce_settings_save_checkout', [ $this, 'update_license_status' ], 20, 0 );
	...
	private function get_license_status( $license_key ) {
		...
		return __( 'Unknown error', 'woo-conditional-payments' );
	}
